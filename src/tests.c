...
START_TEST(decimal_s21_set_sign_1) {
  ...
  s21_decimal y = {{0, 0, 1, 0b00000000000000000000000000000000}};
  x.sign = 0;
  ck_assert_int_eq(x.sign, y.sign);
}
END_TEST
...
/* ----------------------------------------------------------------
 * int x.exponent(s21_decimal d);
 * ---------------------------------------------------------------- */

START_TEST(s21_set_exponent_1) {
  s21_decimal x = {{0, 0, 0, 0b10000000000000000000000000000000}};
  x.exponent = 15;
  int res1 = x.exponent;
  int res2 = 15;
...
/* ----------------------------------------------------------------
 * void s21_exponent_alignment(s21_decimal *value_1, s21_decimal *value_2);
 * ---------------------------------------------------------------- */

START_TEST(s21_exponent_alignment_1) {
  s21_decimal x = {{10, 0, 0, 0b00000000000000000000000000000000}};
  s21_decimal y = {{0, 0, 0, 0b00000000000000000000000000000000}};
  x.exponent = 1;
  y.exponent = 0;
  s21_exponent_alignment(&x, &y);
...
START_TEST(s21_exponent_alignment_2) {
  s21_decimal x = {{10, 0, 0, 0b00000000000000000000000000000000}};
  s21_decimal y = {{1, 0, 0, 0b00000000000000000000000000000000}};
  x.exponent = 2;
  y.exponent = 0;
...
START_TEST(s21_exponent_alignment_3) {
  s21_decimal x = {{10, 0, 0, 0b00000000000000000000000000000000}};
  s21_decimal y = {{1, 0, 0, 0b00000000000000000000000000000000}};
  x.exponent = 28;
  y.exponent = 0;
...
START_TEST(s21_exponent_alignment_4) {
  s21_decimal x = {{10, 0, 0, 0b00000000000000000000000000000000}};
  s21_decimal y = {{5, 0, 0, 0b00000000000000000000000000000000}};
  x.exponent = 28;
  y.exponent = 0;
...
START_TEST(s21_exponent_alignment_5) {
  s21_decimal x = {{10, 0, 0, 0b00000000000000000000000000000000}};
  s21_decimal y = {{5, 0, 0, 0b00000000000000000000000000000000}};
  x.exponent = 0;
  y.exponent = 28;
...
START_TEST(s21_exponent_alignment_6) {
...
START_TEST(s21_exponent_alignment_7) {
...
START_TEST(s21_exponent_alignment_8) {
...
int main(void) {
  ...
  tcase_add_test(tc1_1, s21_get_exponent_1);
  tcase_add_test(tc1_1, s21_get_exponent_2);
  tcase_add_test(tc1_1, s21_get_exponent_3);
  tcase_add_test(tc1_1, s21_get_exponent_4);
  tcase_add_test(tc1_1, s21_get_exponent_5);
  tcase_add_test(tc1_1, s21_get_exponent_6);
  tcase_add_test(tc1_1, s21_get_exponent_1);
  tcase_add_test(tc1_1, s21_set_exponent_1);
  tcase_add_test(tc1_1, s21_set_exponent_2);
  tcase_add_test(tc1_1, s21_set_exponent_3);
  tcase_add_test(tc1_1, s21_set_exponent_4);
  tcase_add_test(tc1_1, s21_set_exponent_5);
  tcase_add_test(tc1_1, s21_set_exponent_6);
  tcase_add_test(tc1_1, s21_exponent_alignment_1);
  tcase_add_test(tc1_1, s21_exponent_alignment_2);
  tcase_add_test(tc1_1, s21_exponent_alignment_3);
  tcase_add_test(tc1_1, s21_exponent_alignment_4);
  tcase_add_test(tc1_1, s21_exponent_alignment_5);
  tcase_add_test(tc1_1, s21_exponent_alignment_6);
  tcase_add_test(tc1_1, s21_exponent_alignment_7);
  tcase_add_test(tc1_1, s21_exponent_alignment_8);
